...
export default function Maintenance() {
  ...
  let formattedTotalCost = `Rp ${totalCost.toLocaleString('id-ID')}`;
  if (totalCost >= 1_000_000_000) {
    formattedTotalCost = `Rp ${(totalCost / 1_000_000_000).toFixed(1)}M`;
  } else if (totalCost >= 1_000_000) {
    formattedTotalCost = `Rp ${(totalCost / 1_000_000).toFixed(1)} Jt`;
  }
